  ...
  return (
    <section className="relative flex h-[50vh]  w-full items-center justify-center bg-[url('/seamey/background.png')] bg-cover bg-center bg-no-repeat px-4 ">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        {/* Small Text & CTA Button */}
        <div className="mt-10 flex flex-col items-center gap-4">
          <p className="text-sm font-semibold text-gray-500">
            Ready to bring an API to life?
          </p>
          
          <button className="group flex items-center gap-2 rounded-full border-2 border-[#f97316] px-8 py-3 text-sm font-bold text-[#f97316] transition-all hover:bg-[#f97316] hover:text-white active:scale-95">
            Generate API
